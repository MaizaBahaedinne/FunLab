<?php
$title = 'Créer une Fermeture';
$pageTitle = 'Créer une fermeture';
$activeMenu = 'closures';
$breadcrumbs = ['Admin' => base_url('admin'), 'Fermetures' => base_url('admin/closures'), 'Créer' => null];
$additionalStyles = '
    .form-section {
        background: #f8f9fa;
        border-radius: 10px;
...
<?= view('admin/layouts/topbar', compact('pageTitle', 'breadcrumbs')) ?>
                ...
                <div class="alert alert-info">
                    ...
                    Les fermetures bloquent les créneaux de réservation pour maintenance, jours fériés, événements privés, etc.
                </div>
                ...
                <form action="<?= base_url('admin/closures/store') ?>" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="form-section">
                        ...
                        <div id="room-selection" <?= old('all_rooms') ? 'style="display:none"' : '' ?>>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-danger">
                            <i class="bi bi-check-circle"></i> Créer la fermeture
                        </button>
                    </div>
                </form>
