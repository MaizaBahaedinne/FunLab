...
<head>
    ...
    <title>Modifier le Jeu - FunLab Admin</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="category" name="category" required>
                                    ...
                                    <option value="Escape Game" <?= old('category', $game['category'] ?? '') === 'Escape Game' ? 'selected' : '' ?>>Escape Game</option>
                                    <option value="VR" <?= old('category', $game['category'] ?? '') === 'VR' ? 'selected' : '' ?>>VR</option>
                                    <option value="Laser Game" <?= old('category', $game['category'] ?? '') === 'Laser Game' ? 'selected' : '' ?>>Laser Game</option>
                                    <option value="Arcade" <?= old('category', $game['category'] ?? '') === 'Arcade' ? 'selected' : '' ?>>Arcade</option>
                                    <option value="Autre" <?= old('category', $game['category'] ?? '') === 'Autre' ? 'selected' : '' ?>>Autre</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="duration" name="duration" 
                                       value="<?= old('duration', $game['duration'] ?? 60) ?>" min="15" max="300" required>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="min_participants" name="min_participants" 
                                       value="<?= old('min_participants', $game['min_participants'] ?? 2) ?>" min="1" max="20" required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="max_participants" class="form-label">Participants max <span class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="max_participants" name="max_participants" 
                                       value="<?= old('max_participants', $game['max_participants'] ?? 6) ?>" min="1" max="50" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="difficulty" name="difficulty">
                                ...
                                <option value="Facile" <?= old('difficulty', $game['difficulty'] ?? '') === 'Facile' ? 'selected' : '' ?>>Facile</option>
                                <option value="Moyen" <?= old('difficulty', $game['difficulty'] ?? '') === 'Moyen' ? 'selected' : '' ?>>Moyen</option>
                                <option value="Difficile" <?= old('difficulty', $game['difficulty'] ?? '') === 'Difficile' ? 'selected' : '' ?>>Difficile</option>
                                <option value="Expert" <?= old('difficulty', $game['difficulty'] ?? '') === 'Expert' ? 'selected' : '' ?>>Expert</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="price" name="price" 
                                       value="<?= old('price', $game['price'] ?? 0) ?>" min="0" step="0.01">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="price_per_person" name="price_per_person" 
                                       value="<?= old('price_per_person', $game['price_per_person'] ?? 0) ?>" min="0" step="0.01">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="deposit_required" 
                                           ...
                                           <?= old('deposit_required', $game['deposit_required'] ?? 0) ? 'checked' : '' ?>
                            ...
                            <div class="col-md-6 mb-3" id="deposit-percentage-group" style="display: none;">
                                ...
                                <input type="number" class="form-control" id="deposit_percentage" 
                                       name="deposit_percentage" value="<?= old('deposit_percentage', $game['deposit_percentage'] ?? 30) ?>" 
                                       min="10" max="100">
                            </div>
                        </div>
                    </div>
