...
<?= view('front/components/hero', [
    'title' => $game['name'],
    'subtitle' => !empty($game['category_name']) ? $game['category_name'] : null,
    'breadcrumbs' => [
        'Accueil' => base_url('/'),
        'Activités' => base_url('games'),
        $game['name'] => null
    ],
    'height' => 'small',
    'background' => !empty($game['image']) ? base_url('uploads/games/' . $game['image']) : 'gradient'
]) ?>
